                    ...
                    <div class="row">
                        ...
                        <?php middleWare(); ?>
                            <div class="form-group level-up form-group-md">
                                ...
                                <input type="text" class="form-control" id="email" name="user" placeholder="Tài khoản">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group level-up form-group-md">
                                <label for="password">Mật Khẩu</label>
                                <input type="password" class="form-control" name="pass" id="password" value="Password">
                            </div>
                        </div>
                        <div class="col-lg-12">
