                        ...
                        <div class="col-lg-11">
                            ...
                            <?php 
                                ...
                                if($showTTCb['0']['hangmb']==1){
                                    $hangMb = "VietJet Air";
                                    $img = '/ban-ve-may-bay/admin/views/img/vietjet.png';
                                }elseif($showTTCb['0']['hangmb']==2){
                                    $hangMb = "Vietnam Airlines";
                                    $img = '/ban-ve-may-bay/admin/views/img/vietnamairlines.png';
                                }elseif($showTTCb['0']['hangmb']==3){
                                    $hangMb = "Bamboo Airways";
                                    $img = '/ban-ve-may-bay/admin/views/img/bamboo.png';
                                } 
                                    ...
                                    <div class="row d-flex justify-content-end">
                                        <div class="col-lg-5">
                                            <div class="form-group">
                                                <a href="/ban-ve-may-bay/admin/index.php?ctrl=loaihang&act=index"> <input type="button"
                                                        name="" id="" value="Huỷ" class="btn btn-cancel"></a>
                                            </div>
                                        </div>
                                        <div class="col-lg-5 pr-2 mr-2">
                                            <div class="form-group">
                                                <a href="/ban-ve-may-bay/admin/index.php?ctrl=hoadon&act=hoantat&idhd=<?=$showHoaDon['id']?>"><input type="submit" name="them" id="" value="Thanh Toán"
