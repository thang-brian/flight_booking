    ...
    <div class="baner-gb bn_copy position-relative">
        <header>            
            <div class="pd-tb-2px position-relative">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm d-none d-sm-block text-white line_h_28">Khoá luận tốt nghiệp</div>
                        <div class="col-sm">
                ...
                <div class="container header-in">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-3">
                            <a id="logo" href="index.php" class="d-inline-block margin-tb-10px"><img src="views/img/logo.png" alt="" width="100px"></a>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-expand-sm navbar-light col-lg-9 col-md-9 col-9 aligh-items-right">
                            <div class="collapse navbar-collapse  link-padding-tb-20px dropdown-dark d-flex justify-content-end " id="navbarNav">
                                <ul class="navbar-nav W-100 d-flex justify-content-end" id="menu-main">
                                    ...
                                    <li class="nav-item">
                                        <a class="" href="<?=SITE_URL?>?act=khuyenmai">DANH SÁCH CHUYẾN BAY</a>
                                    </li>
                                    <li class="nav-item">
        ...
        <div class="row mr-top-8pt">
            <div class="l-box-ud">
                <a href="<?=SITE_URL?>?act=khuyenmai">
                    ...
                    <div class="l-thongtin-ud">
                        <?php if (isset($vjdiemden)) : ?>
                        <div class="l-tuyenduong"><?=isset($vjdiemdi['tinh']) ? $vjdiemdi['tinh'] : ''?> (<?= isset($maSb_vj_di) ? $maSb_vj_di : 0?>) To <br> <?=$vjdiemden['tinh']?> (<?= isset($maSb_vj_den) ? $maSb_vj_den : 0?>)</div>
                        <div class="l-giagoc"><?= isset($vietject['giavethuonggia']) ? number_format($vietject['giavethuonggia'],0,",",".") : '';?> VND</div>
            ...
            <div class="l-box-ud">
                <a href="<?=SITE_URL?>?act=khuyenmai">
                    ...
                    <div class="l-thongtin-ud">
                        <?php if (isset($vndiemdi)) : ?>
                        <div class="l-tuyenduong"><?=$vndiemdi['tinh']?> (<?=$maSb_vn_di?>) To <br> <?=$vndiemden['tinh']?> (<?=$maSb_vn_den?>)</div>
                        <div class="l-giagoc"><?=isset($vietnameairline['giavethuonggia']) ? number_format($vietnameairline['giavethuonggia'],0,",",".") : '';?> VND</div>
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active background-white padding-30px border">
                                ...
                                <i class="d-block mr-tb-20px text-medium text-grey-4">Time to Travel đưa các bạn tới khắp nơi trên Việt Nam. Với những thứ tốt nhất có thể. Chúng tôi đưa bạn đến những nơi xa xôi trên mảnh Đất Việt này và chúng tôi cam kết.
