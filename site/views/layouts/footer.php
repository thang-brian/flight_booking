...
<footer class="te-al-left">
    <div class="container">
      <div class="row pd-tb-100px">
        <div class="col-lg-6">
          <div class="">
            <div class="logo mr-bot-20px"><a href="#"><img src="views/img/logo.png" alt="" width="100px"></a></div>
            ...
            <div class="">
              ...
              <div class="logo mr-bot-20px d-inline-block pd-right-50px"><a href="#"><img src="views/img/bamboo.png" alt=""></a></div>            
            </div>
          </div>
        </div>
        <div class="col-lg-3">
        ...
        <div class="col-lg-3">
          <div class="col-4 padding-tb-7px dl-inline-block float-left">
            <img src="views/img/instagram-1.jpg" class="img-fluid pd-lr-5px" alt="Responsive image">
          </div>
          <div class="col-4 padding-tb-7px dl-inline-block float-left">
            <img src="views/img/instagram-2.jpg" class="img-fluid pd-lr-5px" alt="Responsive image">
          </div>
          <div class="col-4 padding-tb-7px dl-inline-block float-left">
            <img src="views/img/instagram-3.jpg" class="img-fluid pd-lr-5px" alt="Responsive image">
          </div>
          <div class="col-4 padding-tb-7px dl-inline-block float-left">
            <img src="views/img/instagram-4.jpg" class="img-fluid pd-lr-5px" alt="Responsive image">
          </div>
          <div class="col-4 padding-tb-7px dl-inline-block float-left">
            <img src="views/img/instagram-5.jpg" class="img-fluid pd-lr-5px" alt="Responsive image">
          </div>
          <div class="col-4 padding-tb-7px dl-inline-block float-left">
            <img src="views/img/instagram-6.jpg" class="img-fluid pd-lr-5px" alt="Responsive image">
          </div>
        </div>
      </div>
      <div class="row border-top-grey-1 pd-tb-30px">
        <div class="col-4">
          <p class="text-lg-left"><span class="text-third-color">Time to Travel</span></p>
        </div>
        <div class="col-4">
          <div class="text-center"><img src="views/img/cardspay.png" alt=""></div>
        </div>
        <div class="col-4">
          <ul class="icon-fooder list-inline te-al-right margin-0px line_h_28 font-size mr-0">
  ...
  <script src="views/OwlCarousel2-2.3.4/dist/owl.carousel.min.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
  <script src="views/js/binhluan-ajax.js" type="text/javascript"></script>  
