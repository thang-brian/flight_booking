    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <form action="views/vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" cols="20" id="order_desc" name="order_desc" rows="2">thanh toan ve may bay <?=$maThanhToan?></textarea>
                    </div>
                    <div class="form-group">
