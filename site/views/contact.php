<div class="long-lien-he-header-out">
    ...
    <div class="te-center">
        ...
        <div class="cl-te-grey2">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi dicta eveniet deserunt totam perspiciatis. Distinctio veritatis harum totam! Accusamus placeat voluptatibus iure aperiam harum itaque quos, recusandae nihil necessitatibus mollitia!</p>
        </div>
    </div>
    <div class="link">
        ...
        <div class="container mr-bot-100px">
            <div class="row padding-30px mr-50px">
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <h6>Phone :</h6>
                    <span class="d-block"><i class="fa fa-phone text-main-color margin-right-10px" aria-hidden="true"></i> +1900 000 000 </span>
                    <span class="d-block"><i class="fa fa-mobile text-main-color margin-right-10px" aria-hidden="true"></i> +1900 000 000 </span>
                    <h6 class="margin-top-20px">Address :</h6>
                    <span class="d-block"><i class="fa fa-map text-main-color margin-right-10px" aria-hidden="true"></i> 254 Nguyễn Văn Linh, Đà Nẵng </span>
                    <h6 class="margin-top-20px">Email :</h6>
                    <span class="d-block"><i class="fa fa-envelope-open text-main-color margin-right-10px" aria-hidden="true"></i> timetotravel@gmail.com </span>
                </div>
            </div>
        </div>
    </section>
