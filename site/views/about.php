<div class="long-ab-us-header-out">
    ...
    <div class="te-center">
      ...
      <div class="cl-te-grey2">
       <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea incidunt voluptatibus sit fuga repellat optio nesciunt laborum mollitia iste, sequi qui nisi deserunt omnis cupiditate quisquam. Eaque facilis similique deleniti!</p>
      </div>
    </div>
    <div class="link">
        ...
        <div class="row justify-content-md-center">
          <div class="col-lg-8">
            ...
            <p class= "cl-te-grey2 mr-bot-30px">
              Là công ty du lịch trực tuyến hàng đầu Đông Nam Á, Time to Travel đáp ứng đa dạng các nhu cầu du lịch trên cùng một nền tảng, giúp khách hàng có được những chuyến du lịch tuyệt vời với người thân yêu. Travelz cung cấp dịch vụ đặt vé máy bay và dự kiến Với hơn 100 đối tác hàng không nội địa và quốc tế, Time to Travel mang đến hơn 200.000 chặng bay trên toàn thế giới. Ngoài ra, Travelz còn cung cấp dịch vụ hỗ trợ khách hàng 24/7 bằng tiếng địa phương.                    </p>
            <a href="#" class="btn btn-danger mr-right-20px">Buy Now</a>
            <a href="#" class="btn btn-warning">Contact Us</a>
          </div>
        </div>
        <img src="views/img/about-img-1.jpg" alt="">
      </div>
    </div>
    <div class="cl-grey background-overlay pd-tb-100px" style="background-image: url('views/img/page-title-1.jpg');">
      <div class="container z-index-2 position-relative">
        <a href="#" class="btn btn-danger float-right">Buy Now</a>
        <h5>Cơ hội ra nước ngoài với hàng ghế thượng lưu</h5>
      </div>
    </div>
    <!-- <div class="pd-tb-100px background-light-grey">
        <div class="container">
            <div class="services-out">
                <div class="row text-center">
                    <div class="col-lg-3 col-md-6 mr-0-at">
                        <h3><i class="fa fa-plane icon-round"></i>
                            <span class="text-medium text-uppercase">booking flight</span></h3>
                        <i class="d-block cl-te-grey2 mr-bot-20px">Nunc cursus libero purus ac congue arcu cur sus ut sed vitae pulvinar. Nunc cursus libero congue arcu.</i>
                        <a href="#" class="btn background-main-color text-white padding-lr-10px text-small text-uppercase">Read more</a>
                    </div>
                </div>
            </div>
        </div>
