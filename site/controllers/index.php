...
if (!isset($_GET['act']) || ($_GET['act'] == 'home')) {
    ...
    // gía giảm còn
    $giamgia_1 = isset($vietject['giavethuonggia']) && isset($vietject['giamgia']) ? ($vietject['giavethuonggia'] * (100 - $vietject['giamgia'])) / 100 : 0;
    $giamgia_2 = isset($vietnameairline['giavethuonggia']) && isset($vietnameairline['giamgia']) ? ($vietnameairline['giavethuonggia'] * (100 - $vietnameairline['giamgia'])) / 100 : 0;
    $giamgia_3 = isset($bammbo['giavethuonggia']) && isset($bammbo['giamgia']) ? ($bammbo['giavethuonggia'] * (100 - $bammbo['giamgia'])) / 100 : 0;
    $giamgia_4 = isset($pacific['giavethuonggia']) && isset($pacific['giamgia']) ? ($pacific['giavethuonggia'] * (100 - $pacific['giamgia'])) / 100 : 0;
